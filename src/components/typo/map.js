...
//map component for displaying the location used in contact us.js
//componets sets the default location on load and,and displays the location based SingleLineGridList.js component data.
export class MapContainer extends Component {
  ...
  //function to set associationdata  which is sent as prop to SingleLineGridList
  ...
  displayMarkers = (assocval) => {
    ...
    return (
      <Marker
        ...
        position={
          assocval.latitude && assocval.longitude
            ? {
